...
/// - Tag, unencrypted: 	Data in the tags dictionary which key is prefixed with `~` gets stored separately and unencrypted.
/// 				These properties can be fully addressed in query filters.
